...
// UNIT TEST FOR MULSU INSTRUCTION
...
void testMULSU (sbyte regD, sbyte regR, sbyte initSreg) {
    sbyte sreg = initSreg;
    sbyte result;

    sword16 outData = ((__int8_t)regD) * regR; //signed * unsigned
    sreg &= 0xFC;
...
int main(int argc, char *argv[])
{
    ...
    printf("0xFFTimes0xFF - Return 0xFF01\n");
    testMULSU(0xFF,0xFF,0x00);
    printf("DataL: %X\n", output.outL);
    printf("DataH: %X\n", output.outH);
