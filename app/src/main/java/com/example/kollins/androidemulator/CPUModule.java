...
public class CPUModule implements Runnable, CPUInstructions {
    ...
    public enum Executor {
        ...
        INSTRUCTION_ADD {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: ADD");
            }
        },
        INSTRUCTION_ADIW {
            @Override
        ...
        INSTRUCTION_ANDI {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: ANDI");
            }
        },
        INSTRUCTION_ASR {
            @Override
        ...
        INSTRUCTION_CPSE {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: CPSE");
            }
        },
        INSTRUCTION_DEC {
            @Override
        ...
        INSTRUCTION_ICALL {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: ICALL");
            }
        },
        INSTRUCTION_IJMP {
            @Override
        ...
        INSTRUCTION_LD_X_UNCHANGED {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: LD_X_UNCHANGED");
            }
        },
        ...
        INSTRUCTION_LD_Z_UNCHANGED {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: LD_Z_UNCHANGED");
            }
        },
        INSTRUCTION_LDD_Y {
            @Override
        ...
        INSTRUCTION_LPM_Z_POST_INCREMENT {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: LPM_Z_POST_INCREMENT");
            }
        },
        ...
        INSTRUCTION_OR {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: OR");
            }
        },
        ...
        INSTRUCTION_ST_Z_UNCHANGED {
            @Override
            public void executeInstruction() {
                Log.w(UCModule.MY_LOG_TAG, "Not implemented instruction: ST_Z_UNCHANGED");
            }
        },
        INSTRUCTION_STD_Y {
            @Override
